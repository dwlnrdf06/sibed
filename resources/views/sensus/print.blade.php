...
<div class="no-print mb-3 p-3">
    ...
    <a href="{{ route('sensus') }}" class="btn btn-danger">← Kembali</a>
</div>
...
<table>
    <thead>
        ...
        <tr>
            <th>Nama</th><th>No RM</th><th>Kamar</th>
            <th>Nama</th><th>No RM</th><th>Kamar</th>
            <th>Nama</th><th>No RM</th><th>Kamar</th><th>Dari</th>
            <th>Nama</th><th>No RM</th><th>Rujukan</th><th>Kamar</th>
        </tr>
    </thead>
    <tbody>
        @php
...
<table>
    <thead>
        ...
        <tr>
            <th>Dirujuk</th><th>Pulang</th><th>Paksa</th>
            <th>&lt;48 Jam</th><th>≥48 Jam</th>
        </tr>
    </thead>
    <tbody>
